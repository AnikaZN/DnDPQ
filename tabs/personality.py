...
@app.callback(Output("prediction-content", "children"),
             [Input("one", "value"),
              ...
              Input("twenty", "value"),
              Input("twenty-one", "value"),
              Input("twenty-two", "value"),
              Input("twenty-three", "value"),
              Input("twenty-four", "value"),
              Input("twenty-five", "value"),
              Input("twenty-six", "value"),
              Input("twenty-seven", "value"),
              Input("twenty-eight", "value"),
              Input("twenty-nine", "value"),
              Input("thirty", "value"),
              Input("thirty-one", "value"),
              Input("thirty-two", "value"),
              Input("thirty-three", "value"),
              Input("thirty-four", "value"),
              Input("thirty-five", "value"),
              Input("thirty-six", "value"),
              Input("thirty-seven", "value"),
              Input("thirty-eight", "value"),
              Input("thirty-nine", "value"),
              Input("forty", "value"),
              Input("forty-one", "value"),
              Input("forty-two", "value"),
              Input("forty-three", "value"),
              Input("forty-four", "value"),
              Input("forty-five", "value"),
              Input("forty-six", "value"),
              Input("forty-seven", "value"),
              Input("forty-eight", "value"),
              Input("forty-nine", "value"),
              Input("fifty", "value"),
              Input("fifty-one", "value"),
              Input("fifty-two", "value"),
              Input("fifty-three", "value"),
              Input("fifty-four", "value"),
              Input("fifty-five", "value"),
              Input("fifty-six", "value"),
              Input("fifty-seven", "value"),
              Input("fifty-eight", "value"),
              Input("fifty-nine", "value"),
              Input("sixty", "value"),
                 ])
def predict():
    prediction =
